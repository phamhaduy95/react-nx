...
import { DropDownStoreProvider, useDropDownStore } from './DropDownStoreProvider';
...
function WrappedDropDown(props:DropDownProps) {
  ...
  return (
    <div className="DropDown" tabIndex={0} ref={ref} onKeyDown={handleKeyPress}>
      <div className="DropDown__Trigger"  onClick={handleClickToOpenPopup}>ItemsList</div>
      <DropDownMenu targetRef={ref}>
          {children}
      </DropDownMenu>
    </div>
  );
